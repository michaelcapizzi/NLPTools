...
libraryDependencies ++= Seq(
  ...
  "org.elasticsearch" % "elasticsearch" % "1.5.2",        //elastic
  ...
  "org.facebook4j" % "facebook4j-core" % "2.2.2",         //facebook API
  "org.scala-tools" % "maven-scala-plugin" % "2.15.2",    //??
  "com.github.fommil.netlib" % "all" % "1.1.2",           //dependency for ??
  "javax.servlet" % "javax.servlet-api" % "3.0.1" % "provided",
  "org.apache.spark" % "spark-core_2.11" % "1.3.1",       //spark
  "org.apache.spark" % "spark-streaming_2.11" % "1.3.1",  //spark
  "org.apache.spark" % "spark-mllib_2.11" % "1.3.1"       //spark machine learning
